...
public class activity_Aeps_Deposit_Receipt extends AppCompatActivity implements LogOutTimer.LogOutListener {
    private String TAG="AEPS deposit";
    @Override
    ...
    String agent_phone_number,agent_name,transtype="AEPS DEPOSIT",latitude,longitude,ipAddress,timestamp,available_balance,bankName,aadhaar_number,trans_id,agentid,rrn_no,custName,message,trans_amount,macAddress,androidId,fpTransId,status,status_code,transaction_type="Withdraw";
    Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__aeps__deposit__receipt);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(activity_Aeps_Deposit_Receipt.this, activity_Aeps_HomeScreen.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                startActivity(intent);
            }
        });
